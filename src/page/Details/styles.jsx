...
export const MaisProdutos = styled.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    color: white;
...
export const BotaoMore = styled.button`
...
export const BotaoAddCard = styled.button`
    font-size: 20px;
    font-weight: 700;
    background: linear-gradient(130deg, rgba(249, 208, 63, 1));
    display: flex;
    align-items: center;
